...
declare class IbanValidationSDK {
    _mode: string;
    _options: any;
    _utility: Utility;
    _features: Feature[];
    ...
    static test(testoptsarg?: any, sdkoptsarg?: any): IbanValidationSDK;
    tester(testopts?: any, sdkopts?: any): IbanValidationSDK;
    toJSON(): {
        name: string;
    };
    toString(): string;
...
declare const SDK: typeof IbanValidationSDK;
export { stdutil, config, BaseFeature, IbanValidationEntityBase, IbanValidationSDK, SDK, };
