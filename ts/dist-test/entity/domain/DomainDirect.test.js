...
(0, node_test_1.describe)('DomainDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IbanValidationSDK({
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'IBAN_VALIDATION_TEST_DOMAIN_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.IbanValidationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.IBAN_VALIDATION_APIKEY,
        }));
        let idmap = env['IBAN_VALIDATION_TEST_DOMAIN_ENTID'];
    ...
    const client = new __1.IbanValidationSDK({
        base: 'http://localhost:8080',
