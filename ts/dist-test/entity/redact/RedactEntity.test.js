...
(0, node_test_1.describe)('RedactEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set IBAN_VALIDATION_TEST_REDACT_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['IBAN_VALIDATION_TEST_REDACT_ENTID'];
    ...
    idmap = env['IBAN_VALIDATION_TEST_REDACT_ENTID'];
