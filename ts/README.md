# IbanValidation TypeScript SDK



The TypeScript SDK for the IbanValidation API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/iban-validation-sdk/releases](https://github.com/voxgig-sdk/iban-validation-sdk/releases)
...
```ts
const client = IbanValidationSDK.test()
...
```ts
const client = new IbanValidationSDK({ apikey: '...' })
...
| `tester(testopts?, sdkopts?)` | `IbanValidationSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `IbanValidationSDK.test(testopts?, sdkopts?)` | `IbanValidationSDK` | Create a test-mode client. |
...
| `client` | `client(): IbanValidationSDK` | Return the parent SDK client. |
...
iban-validation/
├── src/
│   ├── IbanValidationSDK.ts        # Main SDK class
