# IbanValidation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IbanValidationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IbanValidationSDK(...) and IbanValidationSDK.test(...) become
#      IbanValidationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ibanvalidation_sdk"
_SDK_CLASS = "IbanValidationSDK"
