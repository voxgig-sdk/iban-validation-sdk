# IbanValidation Python SDK



The Python SDK for the IbanValidation API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/iban-validation-sdk/releases)) or
...
client = IbanValidationSDK({
    "apikey": os.environ.get("IBAN_VALIDATION_APIKEY"),
})
```
...
client = IbanValidationSDK(options)
```
...
```
py/
├── ibanvalidation_sdk.py         -- Main SDK module
