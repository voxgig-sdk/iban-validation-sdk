...
#      offline in seeded test mode (IbanValidationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IbanValidation_sdk.rb")
  SDK_CLASS = "IbanValidationSDK"
