...
class IpnEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IBAN_VALIDATION_TEST_IPN_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def ipn_basic_setup(extra)
  ...
  entid_env_raw = ENV["IBAN_VALIDATION_TEST_IPN_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["IBAN_VALIDATION_TEST_IPN_ENTID"])
