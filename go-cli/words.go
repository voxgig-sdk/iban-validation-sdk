...
func registerSDKWords(r *eng.Registry, client *sdk.IbanValidationSDK) {
...
func runOp(client *sdk.IbanValidationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
