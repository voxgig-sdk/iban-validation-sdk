// Command IbanValidation-mcp is an MCP server exposing the IbanValidation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IbanValidation_list  — list records of an entity
//	IbanValidation_load  — load a single record of an entity
//
