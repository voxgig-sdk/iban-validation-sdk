...
func registerTools(server *mcp.Server, client *sdk.IbanValidationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "iban-validation_list",
		Description: "List records from IbanValidation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "iban-validation_load",
		Description: "Load a single record from IbanValidation. " +
...
func runOp(client *sdk.IbanValidationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IbanValidationSDK, name string) (sdk.IbanValidationEntity, error) {
