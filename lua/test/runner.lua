...
function runner.env_override(m)
  local live = runner.getenv("IBAN_VALIDATION_TEST_LIVE")
  local override = runner.getenv("IBAN_VALIDATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IBAN_VALIDATION_TEST_EXPLAIN")
