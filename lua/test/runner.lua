...
function runner.env_override(m)
  local live = runner.getenv("IBANVALIDATION_TEST_LIVE")
  local override = runner.getenv("IBANVALIDATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IBANVALIDATION_TEST_EXPLAIN")
