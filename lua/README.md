# IbanValidation Lua SDK



The Lua SDK for the IbanValidation API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/iban-validation-sdk/releases)),
...
```lua
local sdk = require("iban-validation_sdk")
...
```
lua/
├── iban-validation_sdk.lua    -- Main SDK module
...
The main module (`iban-validation_sdk`) exports the SDK constructor
