...
local IbanValidationSDK = {}
IbanValidationSDK.__index = IbanValidationSDK
...
IbanValidationSDK._make_feature = _make_feature


function IbanValidationSDK.new(options)
  local self = setmetatable({}, IbanValidationSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function IbanValidationSDK:options_map()
...
function IbanValidationSDK:get_utility()
  return Utility.copy(self._utility)
end


function IbanValidationSDK:get_root_ctx()
  return self._rootctx
end


function IbanValidationSDK:prepare(fetchargs)
...
function IbanValidationSDK:direct(fetchargs)
...
-- by passing it.
function IbanValidationSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function IbanValidationSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "IbanValidationSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function IbanValidationSDK:DnsResult(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function IbanValidationSDK:Domain(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function IbanValidationSDK:EmailValidate(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function IbanValidationSDK:Generate(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function IbanValidationSDK:Grammar(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function IbanValidationSDK:Ipn(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function IbanValidationSDK:Redact(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function IbanValidationSDK:Ssl(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function IbanValidationSDK:Utility(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function IbanValidationSDK:Whoi(data)
...
function IbanValidationSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = IbanValidationSDK.new(sdkopts)
  sdk.mode = "test"
