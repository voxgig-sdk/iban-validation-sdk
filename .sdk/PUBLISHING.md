...
|---|---|---|
| `ts/` | @voxgig-sdk/iban-validation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/iban-validation-sdk \
      --repository voxgig-sdk/iban-validation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/iban-validation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/iban-validation-sdk --id=<id>` removes it.
