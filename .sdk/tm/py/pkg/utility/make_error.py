# IbanValidation SDK utility: make_error
...
def make_error_util(ctx, err):
    if ctx is None:
        ...
        ctx = IbanValidationContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, IbanValidationError):
        errmsg = err.msg
    ...
    msg = "IbanValidationSDK: " + opname + ": " + errmsg
    ...
    sdk_err = IbanValidationError("", msg, ctx)
