...
// IbanValidation SDK utility: fetcher

class IbanValidationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IbanValidationSDK/1.0)';
    ...
    public static function call(IbanValidationContext $ctx, string $fullurl, array $fetchdef): array
    {
