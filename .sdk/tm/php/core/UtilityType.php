...
// IbanValidation SDK utility type

class IbanValidationUtility
{
    ...
    public static function copy(IbanValidationUtility $src): IbanValidationUtility
    {
        $u = new IbanValidationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
