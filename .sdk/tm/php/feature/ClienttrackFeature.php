...
// IbanValidation SDK clienttrack feature
...
class IbanValidationClienttrackFeature extends IbanValidationBaseFeature
{
    ...
    public function PostConstruct(IbanValidationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IbanValidation-SDK';
