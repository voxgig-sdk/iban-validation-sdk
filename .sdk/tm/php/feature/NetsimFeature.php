...
// IbanValidation SDK netsim feature
...
class IbanValidationNetsimFeature extends IbanValidationBaseFeature
{
    ...
    private function _simulate(IbanValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IbanValidationContext $ctx, array $applied): void
    {
        $client = $this->client;
