...
// IbanValidation SDK audit feature
...
class IbanValidationAuditFeature extends IbanValidationBaseFeature
{
    ...
    private function _emit(IbanValidationContext $ctx, string $outcome): void
    {
