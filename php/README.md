# IbanValidation PHP SDK



The PHP SDK for the IbanValidation API — an entity-oriented client using PHP conventions.
...
```php
<?php
require_once 'ibanvalidation_sdk.php';

$client = new IbanValidationSDK([
    "apikey" => getenv("IBAN_VALIDATION_APIKEY"),
]);
```
...
```php
require_once 'ibanvalidation_sdk.php';
$client = new IbanValidationSDK($options);
```
...
```
php/
├── ibanvalidation_sdk.php          -- Main SDK class
...
The main class (`ibanvalidation_sdk.php`) exports the SDK class
