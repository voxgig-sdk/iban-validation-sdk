# IbanValidation PHP SDK Reference

Complete API reference for the IbanValidation PHP SDK.
...
#### `IbanValidationSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): IbanValidationUtility`
