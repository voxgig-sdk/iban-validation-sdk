...
// IbanValidation SDK utility: graphql
//
...
class IbanValidationGraphql
{
    ...
    // equivalent.
    public static function body(IbanValidationContext $ctx): mixed
    {
    ...
    public static function errors(IbanValidationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
