...
class IbanValidationTestRunner
{
    ...
    {
        $live = self::getenv('IBAN_VALIDATION_TEST_LIVE');
        $override = self::getenv('IBAN_VALIDATION_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IBAN_VALIDATION_TEST_EXPLAIN');
...
class_alias('IbanValidationTestRunner', 'Runner');
class_alias('IbanValidationHelpers', 'Helpers');
