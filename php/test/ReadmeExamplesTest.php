...
// IbanValidation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IbanValidationSDK::test)
...
{
    private const SDK_CLASS = 'IbanValidationSDK';
    ...
    private const SDK_BASE = 'ibanvalidation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ibanvalidation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
