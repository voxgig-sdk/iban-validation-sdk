...
// IbanValidation SDK paging feature
...
class IbanValidationPagingFeature extends IbanValidationBaseFeature
{
    ...
    private function _is_list(IbanValidationContext $ctx): bool
    {
