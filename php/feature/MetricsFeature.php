...
// IbanValidation SDK metrics feature
...
class IbanValidationMetricsFeature extends IbanValidationBaseFeature
{
    ...
    private function _record(IbanValidationContext $ctx, bool $ok): void
    {
