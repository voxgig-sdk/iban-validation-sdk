...
// IbanValidation SDK telemetry feature
...
class IbanValidationTelemetryFeature extends IbanValidationBaseFeature
{
    ...
    private function _close(IbanValidationContext $ctx, bool $ok): void
    {
