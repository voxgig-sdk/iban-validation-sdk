...
// IbanValidation SDK timeout feature
...
class IbanValidationTimeoutFeature extends IbanValidationBaseFeature
{
    ...
    private function _with_timeout(IbanValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IbanValidationContext $_ctx, float $ms): void
    {
        $client = $this->client;
