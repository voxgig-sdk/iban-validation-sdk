...
// IbanValidation SDK proxy feature
...
class IbanValidationProxyFeature extends IbanValidationBaseFeature
{
    ...
    public function init(IbanValidationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IbanValidationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
