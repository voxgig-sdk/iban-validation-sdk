...
// IbanValidation SDK streaming feature
...
class IbanValidationStreamingFeature extends IbanValidationBaseFeature
{
    ...
    private function _iterate(IbanValidationResult $result): \Generator
    {
    ...
    private function _streamable(IbanValidationContext $ctx): bool
    {
