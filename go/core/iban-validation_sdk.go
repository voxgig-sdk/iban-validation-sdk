...
import (
	...
	vs "github.com/voxgig-sdk/iban-validation-sdk/go/utility/struct"
)

type IbanValidationSDK struct {
	Mode     string
...
func (sdk *IbanValidationSDK) OptionsMap() map[string]any {
...
func (sdk *IbanValidationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IbanValidationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IbanValidationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IbanValidationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IbanValidationSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IbanValidationSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IbanValidationSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IbanValidationSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IbanValidationSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IbanValidationSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *IbanValidationSDK) DnsResult(data map[string]any) IbanValidationEntity {
...
func (sdk *IbanValidationSDK) Domain(data map[string]any) IbanValidationEntity {
...
func (sdk *IbanValidationSDK) EmailValidate(data map[string]any) IbanValidationEntity {
...
func (sdk *IbanValidationSDK) Generate(data map[string]any) IbanValidationEntity {
...
func (sdk *IbanValidationSDK) Grammar(data map[string]any) IbanValidationEntity {
...
func (sdk *IbanValidationSDK) Ipn(data map[string]any) IbanValidationEntity {
...
func (sdk *IbanValidationSDK) Redact(data map[string]any) IbanValidationEntity {
...
func (sdk *IbanValidationSDK) Ssl(data map[string]any) IbanValidationEntity {
...
func (sdk *IbanValidationSDK) Utility(data map[string]any) IbanValidationEntity {
...
func (sdk *IbanValidationSDK) Whoi(data map[string]any) IbanValidationEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *IbanValidationSDK {
	...
	sdk := NewIbanValidationSDK(sdkopts)
	sdk.Mode = "test"
