# IbanValidation Golang SDK Reference

Complete API reference for the IbanValidation Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *IbanValidationSDK`
